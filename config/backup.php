...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * Lista vazia — só fazemos backup da base de dados, não do código
                 * (que está em git) nem dos assets (que se reconstroem).
                 * Para incluir ficheiros uploadados pelos utilizadores, adicionar
                 * storage_path('app/public') aqui.
                 */
                'include' => [],
